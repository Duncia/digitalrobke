...
<section class="container examples-category-banner pb-md pt-md">
    <div class="container__inner examples-category-banner__inner txt-center">
        ...
        <div class="examples-category-banner__text">
            <h2 class="heading heading--2 pb-md">Examples what can be developed</h2>
            <p class="paragraph content-mx-60">Please check the functionalities and elements - all these and much more can be implemented in the website.</p>
        </div>
        <figure class="examples-category-banner__icon">
...
<main class="container--page pb-md pt-md">   
        ...
        <?php if (have_posts()) :
            ...
            <div class="example-box">
                <div class="example-box__img">
                    <a href="<?php the_permalink(); ?>">
                        <div class="example-box__overlay">
                            <p class="example-box__paragraph pb-sm">Case: <?php the_title(); ?></p>
                        </div>
                ...
                <div class="example-box__text pt-sm pb-sm">
                    ...
                    <p class="example-box__paragraph">Description: <?php echo get_the_excerpt(); ?></p>
                </div>
                <button class="btn btn--purple"><a href="<?php the_permalink(); ?>">More details</a></button>
            </div>
        <?php endwhile;
        else :
    ...
    <!--  
            <div class="example-box">
                <div class="example-box__img">
                    <div class="example-box__overlay">
                        <p class="example-box__paragraph pb-sm">Case: Form / Contact Form</p>
                    </div>
                    <img src="<?php echo get_template_directory_uri() . '/images/home-top-img.svg'; ?>" alt="Edit content"/>
                </div>
                <div class="example-box__text pt-sm pb-sm">
                    
                    <p class="example-box__paragraph">Description: User can contact you</p>
                </div>
                <button class="btn btn--purple"><a href="">More info</a></button>
            </div>
    -->
</main>
