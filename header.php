            ...
            <div class="header__menu" id="header-menu">
                ...
                <div class="icon-linkedin">
                    <a href="https://www.linkedin.com/in/robertasduncia/" target="_blank">
                        <svg class="icon-linkedin__svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 310 310" style="enable-background: new 0 0 310 310;" xml:space="preserve">
                            <g id="XMLID_801_">
                                <path
                                    id="XMLID_802_"
